#include "RequestEnableAccountHandler.h"
...
void NetworkDataHandler::RequestEnableAccount::handle(IConnectionPtr con, const unsigned char *data, size_t len)
{
    ...
    USUAL_PARSE_PROTOBUF_DATA_MACRO(Global::Protocol::Server::Management::RequestEnableAccount, request, data, len, usrcon->getSecondCryptology())
    ...
    GLOBAL_PROTO_WRAPPER_DESC_WITH_ENCRYPT(GLOBAL_PROTOCOL_NETWORK_TAG_RESPONSE_ENABLE_ACCOUNT, response, responseData, usrcon->getSecondCryptology())
