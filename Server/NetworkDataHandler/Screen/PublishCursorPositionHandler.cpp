#include "PublishCursorPositionHandler.h"
...
void NetworkDataHandler::PublishCursorPosition::handle(IConnectionPtr con, const unsigned char *data, size_t len)
{
    ...
    for (auto& v : viewers)
    {
        ...
        GLOBAL_PROTO_WRAPPER_DESC2(GLOBAL_PROTOCOL_NETWORK_TAG_PUBLISH_CURSOR_POSITION, data, len, buf)
        v->send(buf);
    }
}
