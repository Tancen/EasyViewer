#include "ResizeTerminalHandler.h"
...
void NetworkDataHandler::ResizeTerminal::handle(IConnectionPtr con, const unsigned char *data, size_t len)
{
    ...
    USUAL_PARSE_PROTOBUF_DATA_MACRO(Global::Protocol::Terminal::ResizeTerminal, request, data, len, usrcon->getSecondCryptology())
    ...
    do
    {
        ...
        GLOBAL_PROTO_WRAPPER_DESC_WITH_ENCRYPT(GLOBAL_PROTOCOL_NETWORK_TAG_RESIZE_TERMINAL, request, data, room->getOwner()->getSecondCryptology())
